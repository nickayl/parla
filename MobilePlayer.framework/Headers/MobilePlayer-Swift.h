...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MobilePlayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Returns a player initialized from data in a given unarchiver. <code>globalConfig</code> is used for configuration in this
...
/// If <code>true</code>, the view is being added to the window using an animation.
...
///   </li>
///   <li>
///     animated: If <code>true</code>, the view is being added to the window using an animation.
///   </li>
/// </ul>
- (void)viewWillAppear:(BOOL)animated;
/// Notifies the view controller that its view is about to be removed from a view hierarchy.
/// If <code>true</code>, the disappearance of the view is being animated.
...
///   </li>
///   <li>
///     animated: If <code>true</code>, the disappearance of the view is being animated.
///   </li>
/// </ul>
- (void)viewWillDisappear:(BOOL)animated;
- (null_unspecified instancetype)initWithContentURL:(NSURL * _Null_unspecified)contentURL SWIFT_UNAVAILABLE;
@end
